...
<%      
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO bookings (`fullname`,`nic`,`hotelname`,`packagename`,`roomcount`,`facilities`,`email`,`tpno`,`checkin`,`checkout`,`totalprice`,`paymenttype`,`status`) VALUES ('"+fullname+"', '"+nic+"', '"+hotelname+"', '"+packagename+"', '"+roomcount+"', '"+facilities+"', '"+email+"', '"+tpno+"', '"+checkin+"', '"+checkout+"', '"+totalprice+"', '"+paymenttype+"', '"+status+"');");
